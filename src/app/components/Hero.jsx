      ...
      <div className="container mx-auto h-full xl:pt-10">
        ...
        <div className="flex flex-col xl:flex-row justify-center items-center xl:justify-start h-full">
          ...
          <motion.div
            ...
            whileInView="show"
            viewport={{ once: false, amount: 0.6 }}
            className="relative w-full h-full max-h-[50vh] md:max-w-[70vw] xl:md:max-w-[860px] xl:max-h-[520px] xl:absolute xl:-right-[100px] min-[1680px]:right-[120px] xl:top-48"
          >
            <Image
